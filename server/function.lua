	...
	MySQL.Async.fetchAll('SELECT * FROM banlist WHERE targetplayername like @playername', 
	{
		...
		if not data[1] then
			...
			if Config.EnableDiscordLink then
				...
				if permanent == 0 then
					message = ("**"..targetplayername1.."**"..Text.isban.." "..duree..Text.forr..reason.." "..Text.by.." **"..sourceplayername1.."**")
				else
					message = ("**"..targetplayername1.."**"..Text.isban.." "..Text.permban..reason.." "..Text.by.." **"..sourceplayername1.."**")
				end
